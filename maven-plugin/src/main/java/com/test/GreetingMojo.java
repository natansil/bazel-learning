...
public class GreetingMojo extends AbstractMojo {
    public void execute() throws MojoExecutionException {
        ...
        String repoDir = checkoutDir + "/../../../.m2/repository/com/wix/maven-fake-module/1.0.0-SNAPSHOT/fake-maven-module-1.0.0-SNAPSHOT.jar";
        String projDir = checkoutDir + "/maven-fake-module/target/fake-maven-module-1.0.0-SNAPSHOT.jar";
